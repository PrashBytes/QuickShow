...
import { icons, LayoutDashboardIcon, ListCollapseIcon, ListIcon, PlusSquare, PlusSquareIcon } from 'lucide-react'
...
const AdminSideBar = () => {
  ...
  return (
    ...
    max-w-13 md:max-w-60 w-full border-r border-gray300/20 text-sm'>
