        ...
        <div className='group flex flex-wrap gap-4 mt-4 w-max'>
          {nowPlayingMovies.map((movie)=>(
            ...
            onClick={() => setSelectedMovie(movie.id)}>
                <div className='relative rounded-lg overflow-hidden'>
                  ...
                  <div className='flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0'>
         ...
         <div>
          <label className='block text-sm font-medium mb-2'>Select Date and Time</label>
            <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg w-fit'>
              <input
              type="datetime-local"
              value={dateTimeInput}
              ...
              />
                ...
                cursor-pointer'>Add Time</button>
            </div>
         </div>
                  ...
                  <div className='flex flex-wrap gap-2 mt-1 text-sm'>
                    {times.map((time) => (
                      ...
                      flex items-center rounded'>
                        <span>{time}</span>
                        <DeleteIcon onClick={() => handleRemoveDateTime(date, time)}  width={15}
